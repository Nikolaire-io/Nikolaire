...
const BrandingOrAdvertise = () => {
    
  gsap.registerPlugin(ScrollTrigger);

  useGSAP(()=>{
    gsap.to("#third-display .third", {
      x: "-99%",
      scrollTrigger: {
  ...
  return (
    <div className="flex trigger-second items-center justify-center gap-4 flex-col lg:flex-row">
      <div className="w-full lg:h-[calc(100vh-100px)] max-w-md mx-auto bg-white dark:bg-[#09090B] lg:p-8   lg:border-r my-6 border-gray-300 relative ">
        ...
        <div className="flex flex-col justify-center h-full">
          <h2 className="text-3xl font-extrabold text-[#252422] dark:text-[#bababa] mt-6">
            Branding And <br /> Advertising
          </h2>

          <p className="text-gray-600 mt-4 leading-relaxed font-semibold">
          We craft unique identities, digital platforms, and engaging experiences that set brands apart and position them at the heart of culture.
          </p>
          <div className="mt-6">
      ...
      {/* second section */}
      <div id="third-display" className="flex items-center justify-between overflow-x-hidden lg:overflow-x-hidden">

        {/* first display */}
        <div className=" mx-auto third flex lg:h-[calc(100vh-100px)] lg:p-5 p-1 dark:bg-[#09090B]  bg-white overflow-x-hidden overflow-hidden gap-6 justify-around flex-shrink-0 w-full">
          {/* first item */}
...
export default BrandingOrAdvertise;
